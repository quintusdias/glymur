...
Changes coming in 0.9.x
=======================
    * Python 2.7 dropped, support limited to 3.6 and newer.
    * OpenJPEG 1.5 dropped, support limited to 2.3.0 and newer.
    * lxml and gdal will be required.   

Changes coming in 0.8.18
========================
      * Remove build/test on Python 3.4 (EOL).
      * Improve warning message when ICC profile is corrupt.
      * Improve how-do-I doc recipes, include example for ICC profiles.
